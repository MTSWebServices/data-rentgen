...
async def test_get_operation_lineage_with_depth_includes_self_references(
    test_client: AsyncClient,
    async_session: AsyncSession,
    ...
    response = await test_client.get(
        ...
        params={
            "since": since.isoformat(),
            # We start at any operation
            "start_node_id": str(lineage.operations[operation_index].id),
            "depth": 3,
        },
    )
