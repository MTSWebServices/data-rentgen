...
- Add REST API endpoints for managing personal tokens. ([#276](https://github.com/MobileTeleSystems/data-rentgen/issues/276))
...
- Set `output.type` based on executed SQL query, e.g. `INSERT`, `UPDATE`, `DELETE`, and so on. ([#310](https://github.com/MobileTeleSystems/data-rentgen/issues/310))
